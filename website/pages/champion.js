        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-2xl text-slate-400">
              A lightweight long-range ranking based on Elo strength, confederation history, and seeding context.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-lg border border-white/10 bg-white/[0.04] p-6">
            ...
            <p className="mt-3 leading-7 text-slate-400">
              This page is an exploratory forecast. It is useful for comparing relative strength, but it is not a betting recommendation and should be updated as squads, injuries, and live form change.
            </p>
          </div>
        </div>
      </div>
