...
## Public Launch Deployment Flow

Public site name: **World Cup AI Predictor**
...
Share only the Vercel production URL with public users. Do not share `localhost` or Vercel dashboard links.
...
- 18+ only.
- Transparent model explanation with source-backed evidence cards.
